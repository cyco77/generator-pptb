...
export default {
    ...
    writing: (generator, toolConfig) => {
        ...
        generator.fs.copyTpl(
            generator.templatePath('react/package.json'),
        ...
        // Copy tsconfig.json
        generator.fs.copy(
            generator.templatePath('react/tsconfig.json'),
        ...
        if (toolConfig.gitInit) {
            generator.fs.copy(
                generator.templatePath('react/gitignore'),
        ...
        // Copy .npmignore
        generator.fs.copy(
            generator.templatePath('react/npmignore'),
            generator.destinationPath('.npmignore')
        );

        // Copy README
        generator.fs.copyTpl(
            generator.templatePath('react/README.md'),
        ...
        // Copy index.html
        generator.fs.copyTpl(
            generator.templatePath('react/index.html'),
        ...
        // Copy source files
        generator.fs.copy(
            generator.templatePath('react/src/main.tsx'),
            generator.destinationPath('src/main.tsx')
        );

        generator.fs.copy(
            generator.templatePath('react/src/App.tsx'),
            generator.destinationPath('src/App.tsx')
        );
